...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Merge gfm batch-worker outputs.")
    ...
    parser.add_argument(
        ...
        help="S3 prefix for GFM data (used when creating collection if missing).",
    )
    parser.add_argument(
        "--link_type",
        type=str,
...
def main():
    ...
    logging.info("gfm batch merge complete.")
