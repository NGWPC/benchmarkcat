...
class BLEInfo:
    assets = {
        ...
        "flow_file": AssetDefinition.create(
            title="Flow File", description="CSV of flow data", media_type="text/csv", roles=["data"]
        ),
    }
    ...
    columns_list = [
        {
            ...
            "discharge": {"Column description": "Discharge in m^3/s", "Column data source": None, "data_href": None},
        }
    ]
